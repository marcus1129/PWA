...
set_property webtalk.parent_dir /zhome/4a/d/162008/project1/PWA/xillinxProjects/RF/test.cache/wt [current_project]
set_property parent.project_path /zhome/4a/d/162008/project1/PWA/xillinxProjects/RF/test.xpr [current_project]
...
read_vhdl -library xil_defaultlib {
  ...
  /zhome/4a/d/162008/project1/PWA/xillinxProjects/RF/test.srcs/sources_1/new/Full_adder.vhd
...
read_xdc /zhome/4a/d/162008/project1/PWA/xillinxProjects/Nexys_4_DDR_Master.xdc
set_property used_in_implementation false [get_files /zhome/4a/d/162008/project1/PWA/xillinxProjects/Nexys_4_DDR_Master.xdc]

set_param ips.enableIPCacheLiteLoad 0
close [open __synthesis_is_running__ w]

synth_design -top decoder4x16 -part xc7vx485tffg1157-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef decoder4x16.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file decoder4x16_utilization_synth.rpt -pb decoder4x16_utilization_synth.pb"
