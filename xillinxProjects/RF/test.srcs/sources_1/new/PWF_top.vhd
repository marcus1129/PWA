...
entity PWF_top is
    Port (  Clk, Reset : in std_logic;
            ...
            LED, Anode : out std_logic_vector (7 downto 0);
...
signal address1, address2, address3, Const, bus2, Data_OutM : std_logic_vector (7 downto 0);
signal bus1, D_word, bus3, Data_outR : std_logic_vector (15 downto 0);
...
RAM: Ram256X16 port map(clk, reset, bus3, address3, MW, Data_OutM);
...
--SS8: SevenSeg8 port map(reset, clk, D_word, segments, Anode);
